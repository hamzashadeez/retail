...
import { resetPassword } from "./Backend/Customers/resetpassword";
...
function Main() {
  const product = {
    ...
    photo:
      "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/i1-fbb9f541-c653-4340-97fc-9b7775782cae/tanjun-mens-shoe-w8ToA8jr.jpg",
  };
  const vendor = {
    name: "Hamza Ahmad",
    email: "h@gmail.com",
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={() => resetPassword(Customer.email)}>
          Reset Password
        </button>
      </div>
    </div>
